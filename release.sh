...
(cd "$out" && shasum -a 256 agent-temporary agent-temporary-expire.service agent-temporary-expire.timer agent-temporary-boot.service VERSION install.sh uninstall.sh > SHA256SUMS)
