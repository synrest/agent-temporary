...
shasum -a 256 dist/agent-temporary-0.7.2.zip >"$CACHE/zip.sha256"
cmp -s "$CACHE/zip.sha256" dist/agent-temporary-0.7.2.zip.sha256
unzip -tq dist/agent-temporary-0.7.2.zip
tar -tzf dist/agent-temporary-0.7.2.tgz | grep -qx 'package/payload/install.sh'
